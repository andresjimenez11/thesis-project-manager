...
const statusTranslations: Record<string, string> = {
  ...
  [Status.WorkInProgress]: "En progreso",
...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
  const {
    ...
    // Agregar opciones para mejor manejo de cache
  ...
  const moveTask = async (taskId: number, toStatus: string) => {
    try {
      ...
      // Refetch explícito después de actualizar
      refetch();
    } catch (error) {
  ...
  // Asegurar que tasks no sea undefined
